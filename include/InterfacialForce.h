...
class InterfacialForce
{
  ...
  public:
    ...
    void pullingForce(const SurfContainer &S, const value_type* centrosome_position, const value_type* centrosome_velocity,Sca_t &binding_probability, Sca_t &density, Vec_t &Fpull, Vec_t &Fpush, Sca_t &impingement_rate, Vec_t *Fcpull=nullptr, Vec_t *Fcpush=nullptr, value_type *min_dist = nullptr) const;
